...
import com.example.nicode.User.UserListener;
import com.example.nicode.databinding.ActivityUsersBinding;
...
public class UsersActivity extends AppCompatActivity implements UserListener {
    ...
    private void getUsers() {
        ...
        Fdatabase.collection(Constants.KEY_COLLECTION_USERS).get().addOnCompleteListener(task -> {
            loading(false);
    ...
    private void showErrorMessage() {
        binding.texterrorMessage.setText(String.format("%s","ไม่มีผู้ใช้มีอยู่"));
